...
const accessToken = sign({username: loginUserEmail.username,email: loginUserEmail.email,id: loginUserEmail.id,isAdmin:loginUserEmail.isAdmin},process.env.JWT_SECRET)
